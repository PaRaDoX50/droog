            ...
            child: Card(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 16,),
                  AspectRatio(child: Shimmer.fromColors(baseColor: Colors.grey[300],
                      highlightColor: Colors.grey,child: Container(width: double.infinity,color: Colors.grey[300],)),aspectRatio: 4/3,)
                ],
              ),
            ),
          );
