...
class Response{
  ...
  int time; //time at which response was posted(millisecondsfromepoch)
  DocumentSnapshot document;

  Response({this.postId,this.imageUrl,this.time,this.response,this.isSolution,this.responseBy,this.votes,this.document});
}
class Reply{
  String replyBy;
  String reply;
