  ...
  Future<void> mobileSignIn(String phoneNo) async {
    ...
    final vF = (AuthException exception) {
      ...
      _scaffoldKey.currentState.showSnackBar(SnackBar(
        content: Text("Something went wrong" ),backgroundColor: Theme.of(context).buttonColor,
      ));
    ...
    final vC = (AuthCredential credential) async {
      try {
        ...
        _scaffoldKey.currentState.showSnackBar(SnackBar(
          content: FittedBox(child: Text("Something went wrong")),backgroundColor: Theme.of(context).buttonColor,
        ));
      }
    };
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FittedBox(
                    child: Text("By clicking continue you are accepting to Droog's",
                            ...
                            onPressed: () async {
                              ...
                              try {
                                if(_formKey.currentState.validate()) {
                                  ...
                                  await mobileSignIn(mobileController.text);
                                }
